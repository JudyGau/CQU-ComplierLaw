...
执行：
1. cd /bin
2. ./compiler ../test/testcase/function/95_float.sy -s2 -o ../test/output_s2/function/95_float.out 
./compiler ../test/testcase/basic/08_const_array_defn.sy -s2 -o ../test/output_s2/basic/08_const_array_defn.out
    -step: 支持以下几种输入
        s0: 词法结果 token 串
        ...
        S : RISC-v 汇编                                     ### TODO
./compiler ../test/testcase/function/95_float.sy -e -o ../test/output_s2/function/95_float.out 
